...
The application can be deployed on [**Heroku**](https://www.heroku.com), on [**Amazon AWS**](https://aws.amazon.com/) or any other PaaS. For Amazon AWS you can find the intallation commands in the file [install-on-aws.sh](https://github.com/Roberto-Gentili/burningwave-site/blob/main/install-on-aws.sh).
