...
<c:set var="sectionTitle" scope="request" value="Performing tasks in parallel with different priorities in Java"/>

<title>Performing tasks in parallel with different priorities in Java</title>
<meta name="description" content="Here you can find how performing parallel tasks with different priorities in Java" />
