...
<c:set var="sectionTitle" scope="request" value="Executing stringified source code"/>

<title>Executing stringified source code in Java</title>
<meta name="description" content="Here you can find how executing stringified source code in Java" />
